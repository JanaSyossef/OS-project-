...
void the_op() {
    ...
    switch (op) {
        case 1:
            ...
            switch (user_choice) {
                case 1:
                    system("cd transportation/admin && ls");
                    break;
                case 2:
                    system("cd transportation/drivers && ls");
                    break;
                case 3:
                    system("cd transportation/passengers && ls");
                    break;
                default:
        ...
        case 2:
            ...
            switch (user_choice) {
                case 1:
                    ...
                    {
                        case 1:
                            sprintf(command, "cd transportation/admin && sudo chmod %d schedule", permission);
                            system(command);
                            break;
                        case 2:
                            sprintf(command, "cd transportation/admin && sudo chmod %d schedule", permission);
